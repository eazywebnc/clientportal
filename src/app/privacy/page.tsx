...
export const metadata: Metadata = {
  title: "Privacy Policy | ClientPortal",
  description: "ClientPortal privacy policy. How we collect, use, and protect your data.",
};
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <section className="space-y-6 text-gray-300">
          <div>
            ...
            <p>We collect information you provide directly: email address, name, and payment information through Stripe. We also collect usage data including pages visited, features used, and files uploaded to improve our service.</p>
          </div>
          <div>
            <h2 className="text-xl font-semibold text-white mb-2">2. How We Use Your Information</h2>
            <p>Your information is used to provide and improve our client portal service, process transactions, send service-related communications, and ensure security of your account.</p>
          </div>
          <div>
            <h2 className="text-xl font-semibold text-white mb-2">3. Data Sharing</h2>
            <p>We do not sell your personal data. We share data only with: Stripe (payment processing), Supabase (database and file hosting), and Cloudflare (hosting and security).</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p>For privacy-related inquiries: <a href="mailto:contact@eazyweb.nc" className="text-blue-400 hover:underline">contact@eazyweb.nc</a></p>
          </div>
        </section>
      </div>
    </main>
